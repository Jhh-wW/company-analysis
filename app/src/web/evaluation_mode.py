...
#:   [본조사] = 2,000원)보다 커야 한다. 작으면 평가 서버가 유료 호출 «전에» 모든
#:   본조사를 거절해 성능을 잴 구간까지 가지 못한다(2026-09-13 예약액 2배 인상에
#:   맞춰 4,000원으로 함께 올린다).
#:   하루 기준은 본조사 두 건이 들어가도록 잡는다 — 10,000원 ≥ 2 × 4,000원.
DEFAULT_PER_RUN_CAP_KRW: Final[float] = 4000.0
DEFAULT_DAILY_CAP_KRW: Final[float] = 10000.0
