...
FINAL_GATE_REASON_OFFICIAL_EVIDENCE_INCOMPLETE: Final[str] = (
...
FINAL_GATE_DETAIL_PREFLIGHT_OFFICIAL_EVIDENCE_INCOMPLETE: Final[str] = (
    "preflight_official_evidence_incomplete"
)
...
def classify_v2_validation_final_gate_reason(
    ...
    if FINAL_GATE_DETAIL_PREFLIGHT_OFFICIAL_EVIDENCE_INCOMPLETE in normalized_codes:
        return FINAL_GATE_REASON_OFFICIAL_EVIDENCE_INCOMPLETE
