...
#:
#: ★ 사업부문은 이 «공용 기본 집합»에는 없다 — 기존 호출자와의 계약을 지키기
#:   위해서다. 다만 3장 대표 이름 표(`composer.portfolio_names`)는 2026-09-14부터
#:   공시된 사업부문을 «운영 축»으로 함께 소비한다(지주회사 실측: 부문을 빼면 표가
#:   종속회사 제품에만 치우쳤다). 그 확장은 그 모듈의 `PORTFOLIO_NAME_LABELS`가 정한다.
