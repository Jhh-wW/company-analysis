...
_V1_DEMO_PDF_SHA256 = "adb5a0aff14523761e4a745cd3e60e79e2692ed9f06a30a626554a688d1de8d5"
_V1_DEMO_PDF_LENGTH = 92675


def test_v1_PDF는_바이트_불변이다():
    """v2 봉인 소비를 넣어도 canonical(v1) 경로 산출물은 그대로여야 한다."""
