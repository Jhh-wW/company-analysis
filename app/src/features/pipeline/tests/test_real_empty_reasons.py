"""빈칸 사유가 «사실»을 말하는지 못 박는다 (문제로그 P-67).
...
★ 왜 중요한가 — 사용자가 할 일이 갈린다.
  ...
  섞어 말하면 멀쩡한 회사를 포기한다 (P-45와 같은 종류의 사고).

★ 진짜 조사 실측(2026-08-15 · 유료)에서 이 거짓 때문에 **루트로닉·토스씨엑스의
...
def test_뉴스_검색이_실패한_것과_결과가_0건인_것을_가른다():
    """⚠️(우리가 못 가져옴)와 ❌(회사에 자료가 없음)를 섞으면 안 된다 (P-45)."""
...
# ══════════════════════════════════════════════════════════
# ③ 홈페이지 — 붙여 놓고 「안 붙였다」고 말하지 않는다 (P-49)
# ══════════════════════════════════════════════════════════
