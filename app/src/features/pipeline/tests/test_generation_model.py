"""8·9 생성만 «큰 모델»로 올린 것이 안전한지 못 박는다 (문제로그 P-43·P-76).

★ 왜 필요한가 — 작은 모델(haiku)은 후보 60~70줄 중 **2~3개만** 고르고 지시문의
  금지 조항도 어긴다. 실측(2026-08-16, 조건 고정·모델만 교체): 4축 문장 **0 → 16개**.
...
def test_생성_모델은_sampling_값을_받는_세대여야_한다():
    ...
    실측(2026-08-16): `claude-sonnet-5`로 부르면 `BadRequestError`(0원 실패).
