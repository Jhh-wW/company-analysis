...
#: 법인격 표기. 「주식회사 ○○」와 「(주)○○」를 같은 회사로 보려고 떼어낸다.
...
#: 실측 — 「항공사에 따르면 **핀테크사로** 15만원 이상 결제 시 …」는
#:   항공사의 행사지 핀테크사의 활동이 아니다. 「로」는 여기 없으므로 걸러진다.
...
def _company_subject_pattern(company: str) -> Optional[re.Pattern[str]]:
    ...
    회사명 바로 뒤(괄호 설명은 건너뛴다)에 주격·주제격 조사가 붙어 있어야 한다.
      · 「○○코퍼레이션(이하 ○○)이 …」 → 맞음 (괄호를 건너뛴다)
      · 「항공사에 따르면 핀테크사로 …」 → 아님 (「로」는 도구격이다)
    조사 뒤에 한글이 더 붙으면 «다른 회사 이름»이므로 제외한다
      · 회사 「플랫폼사」 · 문장 「플랫폼사엔터테인먼트는 …」 → 아님 (자회사 소식이다)
