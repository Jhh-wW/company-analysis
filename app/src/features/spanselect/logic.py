...
| 바꾼다 | 후보 문장 앞에 딸려온 «목록 순번·기사 말머리» 떼기 |
...
def strip_leading_noise(sentence: str) -> str:
    """문장 앞에 딸려온 «껍데기»를 뗀다 — 목록 순번과 기사 말머리.

    실측으로 확인된 세 가지만 뗀다.
      ① 회사 홈페이지 보도자료 «목록»의 순번 — 「11 제약사, 하반기…」
      ② 기사 말머리 — 「[편집자주] ○○사, …」·「[블루오션 동물 의료기기]②…」
