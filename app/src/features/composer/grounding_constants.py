...
#   (dart_fetcher 평문화 + evidence_collection 세그먼터) 조각내어 세면, 조각 안에
#   «백만원»이 28개 문서·1,670회, «천원»이 16개 문서·232회 나온다. 작성기가
#   인용하는 조각의 주력 금액 단위가 통째로 관문 밖이었다는 뜻이다.
