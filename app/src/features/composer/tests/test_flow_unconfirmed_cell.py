"""흐름표에서 «회사가 안 밝힌 칸»을 어떻게 내보내는지 못 박는다.
  ...
  지키면 다른 쪽이 조용히 망가진다는 것이 2026-08-25에 실제로 확인됐다.
...
⚠️ 정정 (2026-08-25 적대 검수) — 이 머리말은 원래 «(주)진영 6장이 그 빈 76px
...
★ 그래서 채우기는 «화살표 장에만» 건다 (2026-08-25 2차 수정)
  ─────────────────────────────────────────────────────────
...
def test_웹과_PDF가_같은_표를_받는다() -> None:
    ...
    ★ 범위 (2026-08-25 정정) — 이 계약은 «화살표로 그리는 장»에만 해당한다.
...
# ══════════════════════════════════════════════════════════
# ④ 카드로 그리는 장은 «채우지 않는다» (2026-08-25 2차 수정)
# ══════════════════════════════════════════════════════════
