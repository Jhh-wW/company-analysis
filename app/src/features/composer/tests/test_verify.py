...
#: ★ 두 번째 절은 아래 «흩어진 칸» 행이 기댈 자리다 — 8장 원문 절 계약이
#:   후보가 «기댄 절»을 보므로, 행과 낱말이 하나도 겹치지 않는 원문은 그 행을
#:   살려 주지 못한다. 이 시험의 관심사는 칸 «경계»이므로 원문 쪽에서 결속을
#:   만들어 준다(평면 진입점 시험과 같은 방식).
_사람_원문 = (
    "당사는 임직원 교육훈련 제도를 운영하고 인재상을 공시하고 있습니다. "
    "인사부서가 분기마다 교육 절차와 세부 기준을 점검합니다."
)
