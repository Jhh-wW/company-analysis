...
★ 왜 이 파일이 생겼나 (실측 + 제품 결정)
  ─────────────────────────────────────────────────────────
  수치 안전 필터가 「숫자가 든 문장은 구조화 사실이 없으면 삭제」했다.
...
★ 이 시험이 지키는 것
  ...
  ③ 스위치를 끄면 수치 안전 필터의 원래 동작으로 돌아간다

★ «구멍 하나를 막고» 추가한 네 번째 조건 — 증명서가 없을 것
