...
CITATION_RULES_GUIDE: Final[str] = (
    ...
    "«확인» 사실로 만들지 않는다.\n"
    "9. 지주회사·연결보고서는 회사 자체 사업과 종속회사 사업의 주체를 구별한다. "
    "연결대상 회사 수는 배당금을 실제 지급한 회사 수가 아니다. 전체 회사 수와 "
    "별도 배당 설명을 합쳐 «그 회사 전부에서 배당을 받는다»고 쓰지 않는다. "
    "종속회사의 제품은 해당 회사나 사업부문의 이름을 함께 밝힌다.\n"
