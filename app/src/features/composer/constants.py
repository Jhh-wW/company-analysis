...
SECTION_GUIDES: Final[dict[str, str]] = {
    "identity": (
        ...
        "전사 3개년 실적 수치(4장), 회사가 밝힌 미래 계획(6장), 경쟁 평가(9장)."
    ),
    "business_model": (
        ...
        "연도별 실적 추이와 그 변화 원인(4장), 회사가 밝힌 미래 계획(6장), "
        "파트너 계약의 내용(7장)."
    ),
    "portfolio": (
    ...
    "current_challenges": (
        ...
        "★ 회사가 «앞으로 할 일»로 밝힌 문장은 이 장에 담지 말고 6장에 남긴다 — "
        "「…할 계획·예정·방침·목표이다」·「…하겠습니다」·「…할 것으로 전망·"
        "기대된다」·「향후·앞으로」가 붙은 문장이다.\n"
        "★ 어미만 진행형(「…하고 있다」·「…하려 하고 있다」)으로 바꿔 이 장에 "
        "담는 것은 특히 안 된다. 원문에 없던 시제를 만드는 것이고, 같은 사실이 "
        "두 장에 실려 중복으로 걸린 뒤 소유는 6장으로 간다. 원문 어미를 그대로 "
        "옮긴다 — 원문이 「…확보해 나가겠습니다」면 그 문장은 6장 것이다.\n"
    ...
    "future_strategy": (
        ...
        "★ 이 장의 본문 문장은 «앞으로 할 일»만 쓴다. 문장마다 「…할 계획·예정·"
        "방침·목표이다」·「…하겠다고 밝혔다」·「…할 것으로 전망·기대된다」·"
        "「향후·앞으로」 가운데 하나를 «그 문장 안에» 남긴다. 원문이 「…하겠습니다」로 "
        "적은 것을 「…하고 있다」·「…하려 하고 있다」로 옮기면 미래 표지가 사라져 "
        "그 문장은 이 장에서 빠진다.\n"
    ...
    "culture": (
        ...
        "★ 사람과 조직에 관한 자료는 «이 장이 소유한다». 공식 자료에 아래가 "
        "있으면 그것부터 쓴다 — 인재상·핵심가치 선언, 복리후생·보상·교육 제도, "
        "직원 현황(인원·평균 근속연수), 조직개편과 부서 구성, 노사 관계, "
        "의사결정·승인 절차. 이 자료가 있는데 쓰지 않고 다른 소재로 장을 "
        "채우면 안 된다. 반대로 이 자료가 «없으면» 그 소재를 쓰지 않는다 — "
        "«없다»고 적지도 않는다. 확인 범위는 안내문이 따로 밝힌다.\n"
        "이 장이 소유하지 않는 것: 직무별 업무·KPI, 사업 성과·파트너 이야기, "
        "조직 사례 하나를 회사 전체의 문화인 것처럼 넓혀 말하는 것, "
        "재무·회계 이야기(신용위험·유동성·환위험 같은 위험 관리 규정, 회계 "
        "인식·측정 정책). 재무 위험을 «누가» 맡는지 조직으로 설명한 문장만 "
        "예외이고, 규정 자체의 내용은 이 장이 아니라 5장이 다룬다. "
        "회사가 밝힌 미래 계획(6장)도 이 장이 소유하지 않는다.\n"
        "여러 대상을 나열해 자격·인정 조건을 쓸 때는 원문이 대상마다 다르게 정한 "
        "인정·불인정·예외·참고 구분을 그대로 지키고, 한 대상에만 걸린 조건을 "
        "나머지 대상까지 넓혀 쓰지 않는다."
    ),
    "competitive_position": (
        ...
        "추측으로 채우지 않는다.\n"
        "이 장이 소유하지 않는 것: 회사가 밝힌 미래 계획(6장), 자사 실적·제품·"
        "파트너 사실의 재출력. 이미 "
...
#:
#: ★ 최소치 6 → 8 (실측 근거).
#:   작가는 «거의 언제나 최소치»를 쓴다 — 카드사 두 번 실측에서 장별
...
#:   (소재 제조사 5.67 · 상장 엔터사 5.56 = 총 45문장 이상)에 닿으려면 작가 산출이
...
CITATION_RULES_GUIDE: Final[str] = (
    ...
    "그 장을 가리킨다.\n"
    "8. 원문의 적용 대상·조건·계획 표현을 그대로 지킨다. 특정 상품·일부 고객의 "
    "조건을 회사 전체의 조건으로 넓히지 않는다. 계획·목표를 현재 실적이나 이미 "
    "달성한 차별점으로 바꾸지 않으며, 따옴표를 쓸 때도 뒤의 한정 표현을 자르지 "
    "않는다. 사업 성과만으로 회사가 밝히지 않은 조직문화·의사결정 방식을 "
    "«확인» 사실로 만들지 않는다.\n"
    "9. 원문에서 서로 다른 문장·항목에 따로 있는 두 사실을 한 문장에 함께 적을 수는 있지만, "
    "그 결합으로 원문에 없는 «새 관계»(수량의 범위, 원인·결과, 주체·대상, 시점)를 만들지 "
    "않는다. 새 관계는 원문 «한 곳»이 직접 말할 때만 쓴다(예: 「연결대상 회사 N개」와 "
    "「배당금을 받는다」를 합쳐 «N개 전부에서 배당을 받는다»로 쓰지 않는다). 지주회사·"
    "연결보고서는 회사 자체 사업과 종속회사 사업의 주체를 구별하고, 종속회사의 제품은 "
    "해당 회사나 사업부문의 이름을 함께 밝힌다.\n"
    "10. 한 문장에는 하나의 확인 가능한 사실을 쓴다. 숫자·기간·주체를 "
    "원문에서 함께 확인할 수 없으면 해당 수치를 생략하고 직접 확인되는 "
    "사업·실행 내용을 쓴다. 연결 실적과 별도 실적은 반드시 구분한다.\n"
)
...
#: ★ 왜 2인가 — 기준 보고서 실측 해석 비율은 소재 제조사 17.7% · 상장 엔터사 12.0%이고
...
#: 조각 줄에 원문위치를 붙일 때 쓰는 이름표.
#:
#: ★ 왜 생겼나 (2026-09-06 오프라인 재현) — 3장 안내문은 「원문위치에 이름 표
#:   표기가 있는 조각」을 우선 쓰라고 «두 문장»으로 지시하는데, 조각 줄에는
#:   종류·문서명·지원 주장슬롯만 실렸고 원문위치가 «한 번도» 실리지 않았다.
#:   조각 원문은 표 «한 행»이라, 작가는 그 글자만 보고 어느 칸이 이름인지도
#:   그것이 어떤 이름 표에서 왔는지도 알 방법이 없었다 — 지킬 수 없는
#:   지시였다. 이름표를 실어 지시를 실제로 지킬 수 있게 만든다.
#: ★ 자리를 «지원 주장슬롯 앞»으로 고정한다 — 뒤에 붙이면 조각 줄을
...
#: 최초 본문 검수의 첫 응답이 «읽히긴 했는데» 요청한 번호 일부의 판정이 빠졌을 때,
#: 빠진 문장만 다시 묻는 후속 요청에 덧붙이는 안내.
#: ★ 왜 필요한가 (2026-09-23 뤼튼 실측) — 1차 검수가 50문장을 물었는데 응답은
#:   20행뿐이었고(정상 종료, 형식 정상), 미응답 30문장이 재질의 없이 «검수 미완료»로
#:   제거돼 9장 중 6장이 안내문만 남았다. 부분 응답은 파싱 실패와 같은 «완전성
#:   실패»이므로 같은 재요청 예산(PARSE_RETRY_LIMIT) 안에서 빠진 번호만 다시 묻는다.
#: ⚠️ RETRY_REMINDER 와 다르다 — 그쪽은 「직전 응답을 읽을 수 없었다」는 안내라
#:   여기 쓰면 거짓 안내가 된다.
MISSING_VERDICTS_REMINDER: Final[str] = (
    "\n(직전 응답에 아래 «대조할 문장»의 판정이 빠져 있었다. 아래 번호를 하나도 "
    "빠뜨리지 말고 각각 판정해, 설명 없이 위 «출력 형식»의 JSON만 출력하라.)\n"
)
...
# ★ 2026-09-16 사용자 결정: 독자에게는 «결과»만 말한다. 처리 과정(생성 형식 오류·
#   수치 대조·검수 통과 여부 같은 우리 사정)은 보고서에 싣지 않는다. 그래서 안내문은
#   두 종류뿐이다 — «확인된 자료 부족»과 «우리 쪽 생성 미완료(다시 실행 가능)».
#   상수는 사유별로 남겨 둔다: 어느 경로가 장을 비웠는지는 진단·시험이 상수로 구분한다.
# ══════════════════════════════════════════════════════════
...
NOTICE_INSUFFICIENT_EVIDENCE: Final[str] = "확인된 자료가 부족해 이 장은 비어 있습니다."

#: 수치 후처리로 본문이 비었음 — 남은 표나 회사 자료의 부재를 뜻하지 않는다.
NOTICE_NUMERIC_BODY_WITHHELD: Final[str] = "확인된 자료가 부족해 이 장은 비어 있습니다."

#: 문장은 없지만 그 장의 «표»는 남을 때 쓰는 자료 부족 계열 안내문.
#: ★ 왜 필요한가 (실측 — 메디라인 2026-09-18 보고서 3쪽 4장) — 「확인된 자료가
#:   부족해 이 장은 비어 있습니다」 바로 아래에 2개년 실적 표가 실렸다. 표는
#:   자기 근거로 검증을 통과한 자료라 남는 것이 맞지만, 안내문이 「비어 있다」고
#:   말해 글과 화면이 어긋난다. 위 상수들의 글자는 바꾸지 않고 «표가 남는
#:   경우»에만 이 문장을 쓴다(`dedupe.reconcile_section_notices`).
NOTICE_INSUFFICIENT_EVIDENCE_TABLE_KEPT: Final[str] = (
    "확인된 문장이 부족해 이 장에는 아래 표만 실었습니다."
)

# ── 확보 근거 보고서(2026-09-14 사용자 계약) 안내 ──
#: 이번 조사에서 이 장에 쓸 공식 자료를 하나도 확보하지 못한 경우.
NOTICE_EVIDENCE_NONE: Final[str] = "확인된 자료가 부족해 이 장은 비어 있습니다."
#: 자료는 확보했지만 검증을 마친 문장이 없어 설명을 싣지 못한 경우.
NOTICE_EVIDENCE_NOT_COMPOSED: Final[str] = "확인된 자료가 부족해 이 장은 비어 있습니다."
#: AI 작성·검수가 중간에 멈춰(예산·한도·제공자 장애) 검증되지 않은 초안을 버린 경우.
NOTICE_AI_UNAVAILABLE: Final[str] = (
    "생성이 끝나지 않아 이 장은 비어 있습니다. "
    "다시 실행하면 채워질 수 있습니다."
)
#: 2026-09-16 이전에 생성·저장된 확보 근거 보고서에 실린 옛 안내문. 저장값은 소급
#: 수정하지 않으므로, 저장 보고서를 읽는 판정(보충 조사 출고 등)은 이 글자도 안내문으로 본다.
LEGACY_EVIDENCE_AVAILABLE_NOTICES: Final[frozenset[str]] = frozenset({
...
#   모르므로 눈에 띄는 사실로 전부 몰린다. 완성차사 실측에서 「금융 커버리지
...
#: 문장은 옮겨졌지만 그 장의 «표»는 그대로 남을 때 쓰는 안내문.
#: ★ 왜 따로 두나 (실측 — 4차 유료 실행 멀티캠퍼스 6장) — 「그쪽으로 모았습니다」
#:   라고 적어 놓고 바로 아래에 「회사가 밝힌 성장 계획」 표를 그대로 실었다.
#:   중복 제거는 «문장»만 옮기고 표(경로표·보도표)는 건드리지 않으므로, 문장이
#:   다 빠진 장에도 표가 남는 것이 정상 동작이다. 그런데 안내문이 그 사실을
#:   말하지 않아 화면과 글이 어긋났다. 안내문을 «표가 있는 경우»에만 늘린다.
NOTICE_DUPLICATE_MOVED_TABLE_KEPT: Final[str] = (
    NOTICE_DUPLICATE_MOVED + " 아래 표는 이 장에 그대로 남아 있습니다."
)
...
#   실측 — 다른 엔터사 보고서 48문장 중 42개(87%)에 대괄호 번호가 있었다.
...
#: 실측(다른 엔터사 48문장): 번호 붙은 문장 42→14개(87.5%→29.2%), 총 번호 52→16개.
...
#: 흐름표의 «밝히지 않은» 칸을 나타내는 글 — 지금은 «렌더러의 옅은 표시»와
#: 구형 봉인 호환에만 쓴다.
#:
#: ⚠️ 정정 (2026-09-23 4차 실측) — 예전에는 render·public_manifest가 화살표
#:   장(2·5·7장)의 빈 칸을 이 글로 «채웠다». 그런데 묶음 검수 프롬프트는
#:   값이 있는 칸만 싣기 때문에, 채워진 「미확인」은 **검수 AI가 본 적 없는
#:   노드**인데도 승인된 도식처럼 공개됐다(실제 2장 도식의 끝 칸). 그래서
#:   채우기를 걷어 냈다 — 원행은 빈 칸 그대로 봉인하고, 표시 축소는
#:   `report_standard/visualization.py::_flow`가 한다(끝 빈 칸은 표시에서
#:   빼고, 내부 빈 칸·길이 혼합 행은 라벨 카드로 낸다).
#: ★ 상수를 지우지 않는 이유 — 이미 봉인된 과거 보고서의 도식에는 이 글자가
#:   그대로 들어 있고, 웹(result.html의 data-flow-cell)·PDF(_FlowGraphic)는
#:   이 글자를 «옅은 빈 칸» 모양으로 그리는 분기를 유지해야 한다. 과거
#:   봉인을 새 코드로 재계산하지 않는다.
...
CHALLENGE_FLOW_GUIDE: Final[str] = (
    ...
    "- 과제를 설명한 문장 «바로 뒤»에, 같은 조각 안에서 회사가 앞으로 할 일을 "
    "밝힌 문장이 이어지면 그것이 바로 «회사가 밝힌 대응»이다. 두 문장의 «핵심 "
    "구»를 한 줄의 두 칸으로 나눠 낸다 — 대응 칸에는 뒤 문장을 원문 표현 그대로 "
    "짧게 줄인 구를 넣는다(문장째 옮기지 않는다). 과제만 적고 뒤 문장을 "
    "버리지 않는다.\n"
    "- 대응 칸은 그 줄이 «인용»한 조각 원문에 실제로 있는 말로 쓴다. 원문에 없는 "
    "말로 바꿔 적으면 근거 없는 대응으로 그 줄이 빠진다.\n"
    "- 두 칸 모두 인용 원문에 «그대로 있는 수»만 쓴다. 원문이 세어 주지 않은 "
    "횟수·연속 연수(예: 원문에 없는 「3년 연속」)를 만들지 않는다. 한 칸에라도 "
    "원문에 없는 수가 있으면 그 줄이 통째로 빠져 «대응»까지 함께 사라진다 — "
    "수를 뺀 표현으로 쓰면 대응이 살아남는다.\n"
...
OPERATIONS_FLOW_GUIDE: Final[str] = (
    ...
    "- 원문에 없는 «일반어 한 낱말»로 칸을 채우지 않는다. 「상품」·「제품」·"
    "「판매」·「고객」·「서비스」·「사용자」처럼 어느 회사에나 들어맞는 한 "
    "낱말만 적힌 칸은 아무 말도 하지 않으므로 «빈 칸»으로 처리되어 사라진다. "
    "원문이 부르는 이름을 그대로 쓰고, 그럴 근거가 없으면 그 칸을 비운다.\n"
    "- 같은 장 문장이 어느 쪽 매출이 주력이라고 말했으면 도식도 그쪽을 그린다. "
    "문장과 도식이 서로 다른 말을 하는 줄은 통째로 빠진다.\n"
    "- 매출이 가장 큰 경로를 «첫 줄»에 둔다. 회사가 고객에게 직접 닿는 경로가 "
    "있으면 중간 단계를 끼워 넣지 말고 그대로 쓴다.\n"
    "- 제조를 돕는 기술 협력처럼 «고객에게 닿지 않는» 관계는 경로표에 넣지 "
    "않는다. 그건 본문 문장으로 쓴다.\n"
    "- 「회사가 하는 일」 칸에는 «그 대상을 주어로 삼은 원문»이 밝힌 역할만 쓴다. "
    "이름·목차 조각이나 다른 상품 설명에서 역할을 끌어오지 않는다.\n"
    "- 줄은 최대 5개, 각 칸은 «짧은 이름·구»로 쓴다(한 문장을 통째로 넣지 않는다).\n"
    "- 줄마다 근거 조각 id를 «인용»에 넣는다. 근거가 없으면 그 줄을 넣지 않는다.\n"
...
#:   (소재 제조사 실측 — 재료가 충분했는데도 경로표가 통째로 안 나왔다).
...
#:
#: ★ 왜 추가하나 (실측) — 상장 엔터사 실측에서 3장은 문장 2개·표
#:   0개(그마저 둘 다 «해석» 등급, «확인» 등급 0개)로 9개 장 중 가장
#:   빈약했다. 목업(소재 제조사) 3장은 제품마다 카드 1장씩 «2개»가 있다 — 처음
...
#:   ·「해석 한계」— 「범위·한계」 행은 2026-09-16부터 싣지 않는다. 독자에게
#:     우리가 무엇을 어떻게 확인했는지(처리 과정·범위)를 설명하지 않는다는
#:     결정이라, 이 칸을 여기서 되살리면 그 결정을 되돌리는 것이 된다.
...
STRATEGY_TABLE_GUIDE: Final[str] = (
    ...
    "- 「계획·목표」 같은 낱말이 원문 어딘가에 있다는 것만으로 이 줄을 넣지 "
    "않는다 — 그 자기인용이 «이 대상»의 아직 실행하지 않은 행동·미래 목표를 "
    "실제로 말하는지 확인한다. 현재 진행·상시 서술만 있고 그 대상의 미실행 "
    "미래 부분이 없으면 표에 넣지 않는다. 같은 서술에 그 대상의 명시된 미래 "
    "단계가 있으면 진행 부분은 빼고 그 미래 단계만 남긴다.\n"
    "- 원문 진행형을 미래형으로 고쳐 쓰거나 없는 날짜·시점을 채우지 않는다.\n"
...
#:
#: ★ 왜 바꾸나 (2026-09-05 상장 엔터사 실측) — 같은 보고서에서 흐름표 «6개»가
...
#: ★ 2026-09-06 상장 엔터사 원문 오프라인 재현 — 3장 packet에 대표 IP 이름
#:   조각이 10개 들어갔는데도 운영 보고서 카드에는 그 이름이 한 번도 안
#:   올랐다. 원인이 «둘» 있었다:
#:     ① 조각 줄에 원문위치가 실리지 않아 위 두 문장이 가리키는 표식을
#:        작가가 볼 수 없었다 → `PROMPT_FRAGMENT_LOCATION_LABEL`로 실었다.
#:     ② 이름 표 조각의 원문은 표 «한 행»이라 이름 말고는 아무 서술이 없는
#:        경우가 많고, 그러면 아래 «줄에 넣을 기준»(매출 기여 확인 또는 실행
#:        근거)을 만족할 수 없다. 규칙을 지키는 작가일수록 그 줄을 «빼야»
#:        했다. → 이름 카드를 그 기준에서 명시적으로 빼 준다.
#: ★ 업종을 가리지 않는다 — 규칙은 조각의 «종류 라벨»만 본다. 회사명·그룹명·
#:   상품명 같은 실제 이름을 이 문구에 넣지 않는다(넣으면 그 업종에만 맞는
#:   안내가 되고, 작가가 그 이름을 근거 없이 베낄 위험도 생긴다).
PORTFOLIO_TABLE_GUIDE_V2: Final[str] = (
    ...
    "쓴다(줄임·번역·조합 금지). 괄호 안 설명은 같은 공시 문서에 글자 그대로 "
    "있는 표현만 쓴다. 지어내면 그 칸은 비워진다.\n"
    "- 원문위치에 이름 표 표기(제품·브랜드·사업부문·종속회사·주요 계약)가 "
    "있는 조각이 있으면 그 이름을 우선 쓴다.\n"
    "- ★ 원문위치에 「대표 IP」·「제품」·「브랜드」 표기가 있는 조각이 있으면 "
    "카드 하나는 «반드시» 그 이름들을 담는다. 원문위치의 표기는 "
    "「… · 종류: 이름」 모양이고 «: 뒤가 그 조각의 이름»이다. 「제품·서비스 "
    "범위」에 그 이름들을 «원문 그대로, 3~6개, 원문에 나온 순서대로» 나열한다. "
    "이름을 줄이거나 번역하거나 새로 짓지 않는다.\n"
    "- 사업부문 이름«만» 쓰고 끝내지 않는다 — 부문명은 무엇을 파는지 말해 "
    "주지 않는다. 위 세 종류의 이름이 하나도 없는 표는 이 요구를 채우지 "
    "못한 것이다.\n"
    "- 그 카드의 「제품·서비스명」에는 «이 카드가 인용한 조각에 글자 그대로 "
    "있는» 이름만 쓴다 — 그 이름들을 묶는 사업부문 이름(그 조각도 함께 "
    "인용한다)이나 위 이름 하나 중 하나다. 인용 조각에 없는 제목을 지어내면 "
    "그 칸은 «비워진다».\n"
    "- 그 이름 카드는 아래 «줄에 넣을 기준»을 적용받지 않는다 — 이름 표에 "
    "실렸다는 사실 자체가 근거다. 「중점 추진 근거」에는 그 이름 표가 무엇을 "
    "묶은 표인지를 말로 쓴다.\n"
    "- 카드는 최대 3개 그대로이며, 이름 카드가 그중 하나를 차지한다.\n"
    ...
    "검증에서 통째로 빠진다).\n"
    "- 예외는 «이름 안에 든 수»뿐이다(모델명·공정명·세대 표기 등). 그 이름을 "
    "실은 조각을 그 줄의 «인용»에 넣으면 그대로 쓴다 — 이름에서 수를 빼거나 "
    "고치지 않는다. 이름을 여럿 나열하면 그 이름들이 실린 조각을 «모두» "
    "인용한다.\n"
    "- 「사업적 역할」에는 전체 포트폴리오에서 이 제품이 맡는 기능적 역할을 "
    "쓴다. 근거가 뚜렷하면 «신규·성장·주력·안정» 중 하나로 분류해도 되지만, "
    "이건 회사의 공식 분류가 아니라 «보고서 분류»다 — 회사가 쓴 말인 것처럼 "
...
BUSINESS_FLOW_GUIDE: Final[str] = (
    ...
    "표 규칙:\n"
    "- 경로 하나가 «한 줄»이다. 인용 원문으로 확인되는 핵심 수익 경로만 고른다. "
    "줄 수를 채우려고 근거 없는 경로를 추가하지 않는다.\n"
    "- 각 줄은 «핵심 자산 / 제품·서비스 / 고객 행동·과금 / 반복·확장 수익» "
    "네 칸이다.\n"
    "- 원문이 밝힌 매출원이 둘 이상이면 «각각 한 줄씩» 그린다. 근거가 있는 "
    "매출원을 하나라도 빠뜨리지 않는다 — 큰 쪽만 그리고 나머지를 버리면 이 "
    "회사가 무엇으로 버는지 절반만 말하는 것이 된다.\n"
    "- 원문에 없는 «일반어 한 낱말»로 칸을 채우지 않는다. 「고객」·「판매」·"
    "「상품」·「제품」·「서비스」·「사용자」처럼 어느 회사에나 들어맞는 한 "
    "낱말만 적힌 칸은 아무 말도 하지 않으므로 «빈 칸»으로 처리되어 사라진다. "
    "원문이 부르는 이름을 그대로 쓰고, 그럴 근거가 없으면 그 칸을 비운다.\n"
    "- 「고객 행동·과금」 칸에는 원문이 밝힌 고객 행동과 과금 방식을 쓴다. "
    "고객 행동만 확인되면 그 행동만 쓰고 이용료·수수료 지불을 덧붙이지 않는다. "
    ...
    "- 서비스 출시·제휴·고객 편의·고객 비용 절감만으로 유료 과금이나 "
    "교차판매·반복 매출을 추론하지 않는다. 회사가 받는 대가와 지급하는 비용, "
    "고객이 얻는 혜택을 구분하고, 계획은 계획으로 쓴다.\n"
    "- 이름 목록·목차·제목만 있는 근거는 그 대상이 «있다»만 보인다. 그 대상이 맡은 "
    "역할과 대가 방식은 «그 대상을 주어로 삼은 절»에서 확인한다. 같은 출처의 다른 "
    "상품·서비스 절에 있는 대가 설명을 이 줄로 옮기지 않는다.\n"
    "- 계약 체결·매출 발생은 관계가 있다는 뜻이지 과금 방식이 아니다. 「반복·확장 "
    "수익」에 재예치·반복 수수료·신규 고객 확보를 쓰려면 원문이 그 대상에 대해 "
    "그렇게 밝혀야 한다.\n"
    "- 경로별 매출 비중을 비교할 근거가 있을 때 큰 경로를 «첫 줄»에 둔다.\n"
    "- 줄은 최대 4개, 각 칸은 «짧은 구»로 쓴다(한 문장을 통째로 넣지 않는다).\n"
    "- 줄마다 근거 조각 id를 «인용»에 넣는다. 근거가 없으면 그 줄을 넣지 않는다.\n"
...
# 값이 있는 칸의 주장과 관계를 함께 검수한다. 업종별 과금 어휘를 목록으로
# 승인하지 않고 legacy와 장별 묶음 검수에 같은 의미 판정 기준을 전달한다.
FLOW_RELATION_REVIEW_GUIDE: Final[str] = (
    "\n■ 도식의 주장과 관계 검수\n"
    "값이 있는 모든 칸을 그 행이 실제 인용한 원문과 대조한다. "
    "각 칸의 내용뿐 아니라 칸 사이에 붙인 관계도 같은 회사·상품·부서·고객·"
    "시점의 근거가 있어야 한다. 서로 다른 대상의 사실을 이어 붙이지 않는다. "
    "원문에 없는 상대, 과금, 인과관계, 적용 범위, 반복·확장 수익을 "
    "하나라도 사실처럼 추가한 행은 거짓이다.\n"
    "고객이 무엇을 하고 누구에게 어떤 대가를 내는지, 회사가 무엇을 받아 "
    "수익을 인식하는지를 구분한다. 고객 혜택·비용 절감·회사 비용·수익성 지표를 "
    "고객이 지불하는 요금으로 바꾸지 않는다. 서비스 출시·제휴·상품 결합만으로 "
    "이용료·수수료·교차판매 수익이 확인되는 것은 아니다. 반복 거래나 기간에 "
    "걸친 수익 인식은 원문이 해당 서비스에 대해 실제 밝힌 경우에만 인정한다.\n"
    "원문이 뒷받침한 쉬운 바꿔쓰기는 인정하되 목표·조건·부정·예외를 보존한다. "
    "문화 표의 칸 이름만으로 사업목표를 현재의 전사 운영 원칙으로 인정하지 않는다. "
    "빈 칸은 주장하지 않은 내용이므로 거짓 판정의 이유가 아니다.\n"
    "이름·목차·제목만 담긴 근거는 그 대상의 «존재»만 보인다. 그 칸이 말하는 맡은 "
    "역할, 고객 행동, 대가를 받는 쪽, 대가의 방식, 반복·확장 수익은 각각 그 대상을 "
    "주어로 삼은 원문 절에서 따로 확인한다. 같은 출처의 다른 상품·서비스를 설명하는 "
    "절에서 대가 방식을 빌려 와 이 대상에 붙이지 않는다.\n"
    "계약 체결·매출 발생·거래 규모는 관계와 크기를 말할 뿐 과금 방식이 아니다. "
    "「반복·확장 수익」 칸은 원문이 그 대상에 대해 반복 거래·재예치·후속 구매·"
    "신규 고객 확보를 실제로 밝혔을 때만 인정한다.\n"
    "성장 계획 줄은 「계획·목표」 낱말이 원문 어딘가에 있다는 것만으로 인정하지 "
    "않는다 — 그 자기인용이 «이 대상»의 아직 실행하지 않은 행동·미래 목표를 "
    "실제로 말하는지 확인한다. 진행·상시 서술만 있고 그런 미래 부분이 없으면 "
    "그 줄은 거짓이다. 같은 서술에 미래 단계가 함께 있으면 후보 문구에 «실제로 "
    "그 미래 부분만» 남았는지 원문과 대조해 확인한다 — 남았다고 추정하지 "
    "않는다. 현재 실적·진행 상태를 미래 계획으로 둔갑시킨 줄과 원문에 없는 "
    "시점을 채운 줄은 거짓이다.\n"
)
...
#: 그려진다.
#:
#: ★ 무엇에 쓰나 — 도식 검수 프롬프트가 줄을 「경로」라 부를지 「카드」라
#:   부를지 정한다(`diagram_check.flow_review_row_noun`).
#:   ⚠️ 정정 (2026-09-23 4차 실측) — 예전에는 render·public_manifest의
#:   「미확인」 채우기 범위 판정에도 썼으나, 채워진 「미확인」이 검수 AI가
#:   본 적 없는 노드로 공개되는 결함이 확인돼 채우기 자체를 걷어 냈다
#:   (`FLOW_UNCONFIRMED_CELL` 주석 참조). 빈 칸의 표시 처리는 이제
#:   `report_standard/visualization.py::_flow`가 장 구분 없이 한다.
...
#   «전부 이어 붙여 한 문단»으로 냈다. 소재 제조사 2장은 8문장이 줄바꿈 없이 한
