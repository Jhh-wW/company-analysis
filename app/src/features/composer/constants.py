...
SECTION_GUIDES: Final[dict[str, str]] = {
    ...
    "competitive_position": (
        "9장 «동종업계에서의 경쟁우위» — 이 회사가 같은 업계 안에서 «무엇을 더 "
        "잘하는가»를 쓴다.\n"
        "★ 상대 회사와 숫자를 맞대는 «비교표»를 쓰지 않는다. 공시는 경쟁 관계를 "
        "말하면서도 상대 «이름»은 거의 밝히지 않는다(실측: 4개사 원문에서 법인을 "
        "지목한 문장 0건). 이름 없는 비교는 지어낸 비교가 된다.\n"
        "대신 이렇게 쓴다:\n"
        "- 회사가 공시에서 밝힌 «업계의 모습»(과점인가·진입장벽·규모의 경제 등)\n"
        "- 그 업계에서 이 회사가 가진 «구체적인 강점» — 설비·기술·인증·거래처·"
        "특허·점유율처럼 «공식 자료에 적힌 것»만.\n"
        "- 그 강점이 왜 업계 안에서 의미가 있는지. 이 판단은 «해석» 등급으로 쓴다.\n"
        "★ 「이런 강점이 있다」는 것 자체가 우위다. 상대와 견줘 이겼다는 증거가 "
        "없어도 좋으니, 회사가 가진 것을 강점으로 «분명하게» 써라. 「~일 수도 "
        "있다」처럼 흐리지 마라 — 근거가 있으면 그것은 강점이다.\n"
        "★ 다만 «숫자로 순위를 주장»할 때만(「업계 1위」·「점유율 1위」·「최대 "
        "규모」) 공식 자료에 그렇게 적혀 있어야 한다. 그런 주장은 틀리면 "
        "거짓말이 되기 때문이다. 「선도적」·「우수한」 같은 «정도를 나타내는 "
