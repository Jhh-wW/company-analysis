...
#:
#: ★ 「한」은 일부러 뺐다(2026-09-14 총괄 결정). 「한곳에 통합해 운영한다」·「한편」·
#:   「한번」·「한계」처럼 수량이 아닌 뜻으로 쓰이는 일이 너무 많아, 「한 곳에 모은다」는
#:   장소 서술이 집단 수 단언으로 읽혔다. 숫자 꼴(「1곳」·「1개」)과 「두·세·네…」는 그대로
#:   잡히므로 미탐 위험이 작다 — 하나를 세는 문장은 애초에 «집단 수» 단언이 아니다.
SCOPE_QUANTIFIER_RE_FRAGMENT: Final[str] = (
    r"(?:\d[\d,]*|두|세|네|다섯|여섯|일곱|여덟|아홉|열|수십|수백|수천)\s*"
    r"(?:개사|개|곳|사|명|군데)"
)
#: 범위 한정자 ② — 전량 표현.
