...
★ 왜 필요한가 — 사용자 지적: 「그냥 DART를 뜯어온 거라서, 이러면 그냥 DART를
  ...
  | **시장점유율** | 「써클차트에 따르면…」 |
  | **우발부채·소송** | 계류 중인 소송·분쟁 |
  | **핵심감사사항** (2026-08-27 추가) | 감사인이 이름을 걸고 짚은 급소 |
  | **주요 지적재산권** (2026-08-27 추가) | 출원만 해 두고 아직 등록·매출이 없는 것 |
...
EXTRA_SECTION_HEADS: Final[dict[str, tuple[str, ...]]] = {
    ...
    # ★ 2026-08-27 추가 — 3장(핵심 제품)의 «아직 안 파는 것» 재료.
