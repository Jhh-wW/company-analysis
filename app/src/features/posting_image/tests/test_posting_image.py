...
★ 진짜 AI를 부르지 않는다 — 시험이 바깥 AI 서비스를 부르면 비용이 들고 결과가
  실행할 때마다 달라진다. `extract`에는 항상 가짜 함수를 주입한다.
  `default_extract`도 시험에서는 «부르지 않고» 존재만 본다.

저장·출력에 개인정보 0건 · 이미지 원본 잔존 0건을 함께 못 박는다.
"""
...
# ══════════════════════════════════════════════════════════
# 개인정보가 로그에 안 남는지 (저장·출력에 개인정보 0건)
# ══════════════════════════════════════════════════════════
