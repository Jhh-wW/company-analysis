...
- 2,000원·6,000원은 실제 청구 절대 상한이 아니라 **새 호출 입장 기준**이다
  (2026-09-13 본조사 예약액·하루 한도 2배 인상 이후 값. 각각 본조사 phase
  예약액과 회원·링크 하루 한도를 가리킨다).
...
본조사 2,000원 — 2026-09-13 인상 이후 값)을 `UNKNOWN_LEGACY` 보수부채로 보존한다.
구 표는 삭제하지 않는다.
