...
정본: 확정/기획서/06_검증/05_칸판정코드.md
성립 세기(O0)는 **7칸**(附 제외 — 표시 전용, 2026-08-14 확정) 중 4칸 + 1번 O + 4번 중 1개.
"""
...
HOMONYM_THRESHOLD = 2         # 동명 법인 2곳 이상이면 본문 고유 단서 검사 (2026-08-14 조건 5)
...
def news_ok(title: str, company: str, published: dt.date, today: dt.date,
    ...
    5 (2026-08-14 신설): **동명 법인이 2곳 이상이면** 기사 본문에 회사 고유 단서
