...
SLOT_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    #   통째로 빈다(실측 — 은행 2025 사업보고서에서 product_role·
    ...
    "portfolio:product_role": (
        "주력 제품", "핵심 제품", "대표 제품",
        # 은행 원문 「다. 주요 상품 및 서비스의 내용」·「4-1. 주요 상품 및
        # 서비스 - 기업상품(상세)」 — 제조업 「주요 제품」에 대응하는 금융업 표기.
        "주요 상품",
        # 은행 원문 「기업금융·자산관리·글로벌 금융 등 핵심 사업 부문을
    ...
    "portfolio:revenue_link": (
        "매출 기여", "매출 비중",
        # 은행 원문 「부문별 영업실적은 이자부문 7조 8,165억원, 수수료부문
        # 7,807억원, 신탁부문 2,123억원입니다」 — 「매출 비중」의 금융업 대응.
        "부문별 영업실적",
        # 은행 원문 「양호한 이자이익을 기록했습니다」·「순이자이익은 7조
    ...
    # (은행 2025 사업보고서에는 두 표현 모두 0회 — 그래서 이 칸이 비어
    ...
    "culture:work_principle": (
        "핵심가치", "원칙에 따라", "행동강령",
        # 은행 원문 「임직원 윤리강령의 제정 및 세부실천방안 마련에 관한 사항」
        "윤리강령",
        # 은행 원문 「임직원의 직업윤리와 준법정신을 중시하는 조직문화의
