...
정본: 확정/기획서/02_판정/01_흐름.md
  [조건 0] 사업자번호가 공공기관 명단에 있나 → 거부 A  (2026-08-27부터 «모든» 경로)
  ...
  [조건 2] 공개된 재무 자료가 있나 → 비상장 외감 / 없으면 거부 B
    ...
    └ 2-b 전자공시에 재무제표가 공개돼 있나 (2026-08-27 추가)

★ 왜 2-b 가 필요했나 (실측 2026-08-27 · 현대카드)
...
def decide(
    ...
    ★ 조건 0(공공기관 대조)을 «맨 위»로 옮겼다 (2026-08-27, 사용자 결정)
